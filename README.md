...
- **⌥⇧Space** — Scroll mode: every scroll area is outlined and numbered; the active one is highlighted. **h/j/k/l** scroll (vim directions), **⇧** dashes, **d/u** half-page, **g/G** top/bottom, **Tab/⇧Tab/⌃N/⌃P/1–9** switch areas. Esc exits.
